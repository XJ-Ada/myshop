...
<tr>
  <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
    <tr>
      ...
      <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">类型名称</span></div></td>
      <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">属性数量</span></div></td>
    ...
    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
      ...
      <td bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($v["attr_num"]); ?></div></td>
      <td bgcolor="#FFFFFF"><div align="center" class="STYLE21">
      &nbsp;<a href="<?php echo U('Attribute/showlist',array('type_id'=>$v['type_id']));?>" target='_self' style='color:rgb(59,99,117)'>属性列表</a>&nbsp;|
