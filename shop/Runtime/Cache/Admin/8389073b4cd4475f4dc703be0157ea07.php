...
<tr>
  <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
    <tr>
      ...
      <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">分类名称</span></div></td>
      <td width="" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">上级</span></div></td>
    ...
    <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
      ...
      <span class="STYLE19"><?php echo ($v["cat_id"]); ?></span></div></td>
