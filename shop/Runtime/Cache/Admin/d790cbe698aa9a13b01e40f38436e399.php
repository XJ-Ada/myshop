  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">重量</span></div></td>
        ...
        <td height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">logo图片</span></div></td>
        <td width="*" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">详情描述</span></div></td>
        <td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">基本操作</span></div></td>
      </tr>

      <!--foreach name='数组' key='下标' item='值'-->
      <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
        <td bgcolor="#FFFFFF"><div align="center">
          <input type="checkbox" name="checkbox2" id="checkbox2" />
        </div></td>
        <td bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><?php echo ($v["goods_id"]); ?></span></div></td>
        <td bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($v["goods_name"]); ?></div></td>
        ...
        <td bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($v["goods_price"]); ?></div></td>
        <td bgcolor="#FFFFFF" class="STYLE19"><div align="center">
        <img src='<?php echo (SITE_URL); echo (substr($v["goods_small_logo"],2)); ?>' alt='logo图片' width='100' height='100' />
        </div></td>
        <td bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($v["goods_introduce"]); ?></div></td>
        <td bgcolor="#FFFFFF"><div align="center" class="STYLE21">
        <img src="<?php echo (AD_IMG_URL); ?>del.gif" width="10" height="10" /> 删除 | 查看 | <img src="<?php echo (AD_IMG_URL); ?>edit.gif" width="10" height="10" /> <a style='color:rgb(59,99,117)' href="<?php echo U('upd',array('goods_id'=>$v['goods_id']));?>">编辑</a></div></td>
