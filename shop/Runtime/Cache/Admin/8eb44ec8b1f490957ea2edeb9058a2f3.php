...
<tr>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id='general-tab-show'>
    <tr>
      <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">商品类型名称：</span></div></td>
      <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="left">
      <input type="text" name="type_name" />
      </div></td>
    </tr>
    
    <tr><td colspan='100' bgcolor="#FFFFFF" align="center"><input type='submit' value='添加商品类型'></td></tr>
  </table>
